function Xkf= DMKalman(initQ,initR,Vref,connectivity,transfer_matrix,observations,states,...
...
for k=3:time
    ...
    B = getControlMatrix(Vref,connectivity,Xkf(:,k-1),...
        deltaIndex,excitable_threshold,exciting_threshold);
